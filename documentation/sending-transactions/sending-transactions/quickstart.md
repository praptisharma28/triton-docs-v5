...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><i class="fa-paper-plane">:paper-plane:</i> <strong>Jet TPU client</strong></td><td>Full client-side control: send straight to validator TPUs over QUIC with callbacks and custom routing.</td><td><a href="jet-sender">Jet TPU client</a></td></tr><tr><td><i class="fa-arrow-trend-up">:arrow-trend-up:</i> <strong>Priority fees API</strong></td><td>Estimate a priority fee that lands under congestion.</td><td><a href="priority-fees-api">Priority fees API</a></td></tr><tr><td><i class="fa-list-check">:list-check:</i> <strong>Best practices</strong></td><td>Land transactions reliably under congestion.</td><td><a href="best-practices">Best practices</a></td></tr></tbody></table>

...
_Adapted from the_ [_Solana `programUnsubscribe` reference_](https://solana.com/docs/rpc/websocket/programunsubscribe)_, maintained by the Solana Foundation._

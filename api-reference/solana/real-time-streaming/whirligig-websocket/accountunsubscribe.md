...
_Adapted from the_ [_Solana `accountUnsubscribe` reference_](https://solana.com/docs/rpc/websocket/accountunsubscribe)_, maintained by the Solana Foundation._

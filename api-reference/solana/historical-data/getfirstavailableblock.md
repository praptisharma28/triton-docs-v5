---
description: Returns the lowest confirmed block slot still available in this node's ledger.
layout:
  width: default
  title:
    visible: true
...
_Adapted from the_ [_Solana `getFirstAvailableBlock` reference_](https://solana.com/docs/rpc/http/getfirstavailableblock)_, maintained by the Solana Foundation._

---
description: Returns the block height the node sees at the requested commitment.
layout:
  width: default
  title:
    visible: true
...
_Adapted from the_ [_Solana `getBlockHeight` reference_](https://solana.com/docs/rpc/http/getblockheight)_, maintained by the Solana Foundation._

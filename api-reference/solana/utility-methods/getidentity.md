---
description: Returns this RPC node's identity Pubkey.
layout:
  width: default
  title:
    visible: true
...
_Adapted from the_ [_Solana `getIdentity` reference_](https://solana.com/docs/rpc/http/getidentity)_, maintained by the Solana Foundation._

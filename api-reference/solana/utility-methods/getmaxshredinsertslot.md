...
_Adapted from the_ [_Solana `getMaxShredInsertSlot` reference_](https://solana.com/docs/rpc/http/getmaxshredinsertslot)_, maintained by the Solana Foundation._

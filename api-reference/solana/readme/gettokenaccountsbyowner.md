---
description: Returns SPL Token accounts whose owner matches the supplied address.
layout:
  width: default
  title:
    visible: true
...
_Adapted from the_ [_Solana `getTokenAccountsByOwner` reference_](https://solana.com/docs/rpc/http/gettokenaccountsbyowner)_, maintained by the Solana Foundation._

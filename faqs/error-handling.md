...
If the same issue exists with Solana, identify the bug and resolution by following the standard list of [Common Solana JSON-RPC codes](https://kate-6.gitbook.io/triton-one-docs-v5/faqs/solana/error-handling/common-solana-errors).
...
* Determine if your issue returns any of the [Triton RPC error codes](https://kate-6.gitbook.io/triton-one-docs-v5/faqs/solana/error-handling/triton-rpc-error-codes).
* Determine if your issue exhibits any of the possible Triton RPC symptoms.
* Determine if your issue fits any of the uncommon [Web3JS errors](https://kate-6.gitbook.io/triton-one-docs-v5/faqs/solana/error-handling/web3js-socket-connection-issues) we helped some of our customers resolve.

...
| Not found. Verify the existence of requested data, often associated with requesting a price that does not exist related to the Pythnet service.                                                                                                                        | 404                  | Client                 |

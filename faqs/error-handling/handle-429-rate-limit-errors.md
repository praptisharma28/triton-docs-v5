...
A 429 means at least one of those budgets was exceeded. See [Rate and connection limits](https://app.gitbook.com/s/ACym6ZbIwDBDKhyKgDGy/get-started/rate-and-connection-limits) for the exact defaults and how to read your endpoint's live limits.

...
Keep the token server-side only. Frontend code uses an origin allowlist instead. See [Auth and security](authentication). Full walkthrough: [Set up your account](platform-overview).
{% endstep %}
